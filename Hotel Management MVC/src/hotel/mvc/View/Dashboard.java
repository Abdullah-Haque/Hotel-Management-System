...
public class Dashboard extends JFrame{
    ...
    public Dashboard() {
        ...
        Image i2 = i1.getImage().getScaledInstance(1280, 768,Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2); 
	JLabel NewLabel = new JLabel(i3);
	NewLabel.setBounds(0, 0, 1280, 768); 
        add(NewLabel);
        
        JLabel AirlineManagementSystem = new JLabel("THE TAJ GROUP WELCOMES YOU");
	AirlineManagementSystem.setForeground(Color.WHITE);
        AirlineManagementSystem.setFont(new Font("Tahoma", Font.PLAIN, 20));
	AirlineManagementSystem.setBounds(200, 30, 400, 85);
