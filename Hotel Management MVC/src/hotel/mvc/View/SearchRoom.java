...
import hotel.mvc.Controller.roomController;
import java.sql.*;
import javax.swing.*;
    ...
    public SearchRoom() throws SQLException {
        ...
        btnSearch.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                    ...
                    rs = roomController.getRoomsbyBedType(c1.getSelectedItem());
                    table.setModel(DbUtils.resultSetToTableModel(rs));

                    if (checkRoom.isSelected()) {
                        rs = roomController.getRoomsbyAvailableBedType(c1.getSelectedItem());
                        table.setModel(DbUtils.resultSetToTableModel(rs));
                    }
